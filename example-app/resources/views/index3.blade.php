...
<head>
    ...
    <title>Регистрация - Администрация Сергиево-Посадского городского округа</title>
...
<nav>
    ...
    <main>
    <h2>Регистрация</h2>
    <p>Зарегистрируйтесь, чтобы получить доступ к дополнительным функциям и услугам.</p>
   ...
   <script src="{{ asset('js/navigation.js') }}"></script>
    ...
    <div class="registration-container">
        <form action="{{ route('register') }}" method="POST">
            ...
            <!-- Поле для роли (скрыто для обычных пользователей) -->
